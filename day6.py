...
def go_forward(matrix, guard_i, guard_j):
    ...
    if rotation == "^":
        ...
        matrix, new_position_i, new_position_j = move(
            matrix, guard_i, guard_j, new_position_i, new_position_j, "^", ">")
    ...
    if rotation == ">":
        ...
        # Move player if posible
        matrix, new_position_i, new_position_j = move(
            matrix, guard_i, guard_j, new_position_i, new_position_j, ">", "v")
        return False, matrix, new_position_i, new_position_j
...
def solve_map(matrix_map):
    ...
    while not found:
        found, matrix_map, guard_i, guard_j = go_forward(
            matrix_map, guard_i, guard_j)
